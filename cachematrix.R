...
## This function does the following 4 things:
...
## function. However, it first checks to see if 
## the inverse  has already been calculated. If 
## so, it gets the inverse from the cache and 
